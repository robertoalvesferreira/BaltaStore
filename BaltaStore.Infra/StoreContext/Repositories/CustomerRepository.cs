...
namespace BaltaStore.Infra.StoreContext.Repositories
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public IEnumerable<ListCustomerQueryResult> Get()
        {
            return _context
             .Connection
             .Query<ListCustomerQueryResult>("SELECT [ID],CONCAT([FirstName],' ',[LastName]) AS [Name], [Document],[Email] from [Customers]", new { });
        }
        ...
        public GetCustomerQueryResult GetById(Guid id)
        {
            ...
            _context
           .Connection
           .Query<GetCustomerQueryResult>("SELECT [ID],CONCAT([FirstName],' ',[LastName]) AS [Name], [Document],[Email] from [Customers] WHERE [ID]=@id", new { id = id}).FirstOrDefault();
        ...
        public void Save(Customer customer)
        {
            _context.Connection.Execute("spCreateCustomer",
             new
             {
                 ...
                 LastNamae = customer.Name.LastName,
